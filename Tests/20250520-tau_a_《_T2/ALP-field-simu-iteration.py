...
data_file_name = savedir + f"m_transverse_all_runs_" + timestr + ".npz"
np.savez(
    data_file_name,
    timeStamp=simu.timeStamp,
    m_t=results,
...
# np.save(savedir + f"m_transverse_all_runs_" + timestr + ".npy", results)


# # Sample data
# m_transverse = np.random.rand(1000)
# simuRate = 1000
# duration = 1.0
...
# data_file_name = savedir + f"m_transverse_all_runs_" + timestr + ".pkl"
# df.to_pickle(data_file_name)

# with open(data_file_name, "wb") as f:
#     pickle.dump({"df": df, "m_transverse": results}, f)
